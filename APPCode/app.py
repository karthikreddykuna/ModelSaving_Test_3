...
tpot_data = pd.read_csv('ModelSaving_Test_3/Model/https://raw.githubusercontent.com/karthikreddykuna/ModelSaving_Test_3/master/APPCode/prepared_data.csv')
...
title = 'App'
encoder_location = ''
target_encoder_location = 'https://github.com/karthikreddykuna/ModelSaving_Test_3/blob/master/APPCode/target_encoder.pkl?raw=true'
